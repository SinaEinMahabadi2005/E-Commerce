import { Box, Button, TextField, Typography, Container, Paper, Stack, Divider, InputAdornment, CircularProgress } from "@mui/material";
import { Person, Lock, Login, HowToReg } from "@mui/icons-material";
          ...
          <Stack spacing={3}>
            ...
            <Box textAlign="center">
              ...
              >
                ...
                <Typography
                  component="span"
                  onClick={() => !loading && handlePageTypeChange()}
                  sx={{
                    color: 'primary.main',
                    fontWeight: 600,
